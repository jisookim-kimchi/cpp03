...
/*   Updated: 2026/03/01 18:22:17 by jisokim2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name, unsigned int hp, unsigned int mp, unsigned int attackDamage) 
    : _name(name), _hitPoints(hp), _energyPoints(mp), _attackDamage(attackDamage)
{
    std::cout << "ClapTrap " << this->_name << " HP : " << _hitPoints << " MP : " << _energyPoints << " attackDamage : " << _attackDamage << " created" << std::endl; 
}
